...
{
    public float baseSpeed = 0.5f;              // Normal speed
    ...
    void Start()
    {
        currentSpeed = baseSpeed;               // Set the initial speed
    }
    ...
    void Update()
    {
        if (loose == false)
        {
            ...
            {
                currentSpeed = baseSpeed * rainSpeedMultiplier;  // Slow down during heavy rain
            }
            else
            {
